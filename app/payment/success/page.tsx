      ...
      <div className="max-w-md w-full text-center">
        <div className="bg-card border border-border rounded-lg p-8 mb-6">
          ...
          <div className="bg-accent/20 border border-accent/30 p-4 rounded-lg mb-6">
            <p className="text-sm">
              Kami akan memverifikasi pembayaran dan memproses pesanan Anda
              dalam waktu 24 jam. Anda dapat melacak status pesanan di halaman
              "Pesanan Saya".
            </p>
          </div>
          ...
          <div className="flex flex-col space-y-3">
            <Link
              href="/dashboard"
              className="flex items-center justify-center space-x-2 px-6 py-4 bg-primary text-primary-foreground rounded-lg hover:opacity-90 hover:shadow-lg transition-all"
            >
